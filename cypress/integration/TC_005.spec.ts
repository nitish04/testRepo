...
it("Create Sale request and mark it as Confirmed: and Delivery Status as 'Packed' to deliverAll ", function(){
  ...
  katanaSalesPage.click_on_delivery_Sales()
  katanaSalesPage.click_on_pack_all()
  katanaSalesPage.verifydelivery_pack_status()
  katanaSalesPage.change_Status_from_packed_to_deliverAll()
  katanaSalesPage.verify_order_delivered(maninFlow.prams)
