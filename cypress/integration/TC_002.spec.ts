...
it("Create Sale request and mark it as Confirmed: and Delivery Status as 'Deliver Some' ", function(){
  ...
  katanaSalesPage.mark_orderAs_deliver_some_Sales()
  katanaSalesPage.click_on_include_all()
  katanaSalesPage.click_on_deliver_selected()
